...
assessmentButton.addEventListener(//イベント検知設定の追加
    ...
    ()=>{//アロー関数、イベント検知をしたら実行される
       ...
       resultDivision.appendChild(paragraph);//divタグの子要素としてpタグの追加
        
       //X投稿ボタンの作成
        tweetDivison.innerText='';//tweetのdivタグを空にしている
    ...
    tweetDivison.appendChild(anchor);//divの子要素として追加
